...
class AdminService {
    ...
    async updateAdmin(id, input) {
        ...
        if (input.password)
            data.password = await (0, password_1.hashPassword)(input.password);
    ...
    async updatePlan(id, input) {
        ...
        if (input.yearlyPrice !== undefined)
            updateData.yearlyPrice = input.yearlyPrice;
        if (input.maxContacts !== undefined)
            updateData.maxContacts = input.maxContacts;
        if (input.maxMessages !== undefined)
            updateData.maxMessagesPerMonth = input.maxMessages;
        if (input.maxTeamMembers !== undefined)
            updateData.maxTeamMembers = input.maxTeamMembers;
        if (input.maxTemplates !== undefined)
            updateData.maxTemplates = input.maxTemplates;
        if (input.maxChatbots !== undefined)
            updateData.maxChatbots = input.maxChatbots;
